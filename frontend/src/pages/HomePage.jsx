...
const HomePage = () => {
	...
	return (
		<div className="relative min-h-screen bg-[#0B0C1D] text-white overflow-hidden">
			<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				<h1 className="text-center text-5xl sm:text-6xl font-extrabold text-white mb-4">
					Explore Our Categories
				</h1>

				<p className="text-center text-xl text-[#9CA3AF] mb-12">
